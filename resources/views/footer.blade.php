        ...
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list-inline mt-5">
              ...
              <li class="m-0 pl-10 pr-10"> <i class="fa fa-globe text-theme-colored2 mr-5"></i> <a class="text-gray" href="{{url('/')}}">fidelityinstant.com</a> </li>
            </ul>
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <ul class="list angle-double-right list-border">
              ...
              <li><a href="{{$void}}">Our Service</a></li>
              <li><a href="{{$void}}">Pricing Table</a></li>
              <li><a href="{{$void}}">Project</a></li>         
            </ul>
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
            ...
            <div class="twitter-feed list-border clearfix" data-username="Envato" data-count="2">
              <ul>
                <li class="item"><a href="{{$void}}" target="_blank" title="shanebroadhead on Twitter">@shanebroadhead</a> Hi Smitty, Thanks for your valuable feedback. I will send it to the Envato devs. ^PR <div class="date">Oct. 7, 2022</div></li><li class="item">Increase your <a href="{{$void}}" target="_blank" title="Search for #LogoDesign">#LogoDesign</a> skills and create stand-out designs with these top 10 logo design tutorials from… <a href="{{$void}}" target="_blank" title="Visit this link">https://t.co/Xh2yDX0pDK</a> <div class="date">Oct. 7, 2022</div></li></ul></div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
          <div class="widget dark">
