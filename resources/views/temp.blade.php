<html class="no-js" lang="en"><!-- Mirrored from decentralized-mainnet.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 16:27:03 GMT --><!-- Added by HTTrack --><head><meta http-equiv="content-type" content="text/html;charset=utf-8"><!-- /Added by HTTrack -->
  ...
  <!-- Site Title -->
  <title>Decentralized Dapps - We are help to help you resolve your crypto related issues</title>
...
<body class="cs-dark">
  ...
  <div class="cs-preloader cs-center" style="display: none;">
  ...
  <div style="height:62px; background-color: #1D2330; overflow:hidden; box-sizing: border-box; border: 1px solid #282E3B; border-radius: 4px; text-align: right; line-height:14px; block-size:62px; font-size: 12px; font-feature-settings: normal; text-size-adjust: 100%; box-shadow: inset 0 -20px 0 0 #262B38;padding:1px;padding: 0px; margin: 0px; width: 100%;"><div style="height:40px; padding:0px; margin:0px; width: 100%;"><iframe src="https://widget.coinlib.io/widget?type=horizontal_v2&amp;theme=dark&amp;pref_coin_id=1505&amp;invert_hover=no" width="100%" height="36px" scrolling="auto" marginwidth="0" marginheight="0" frameborder="0" border="0" style="border:0;margin:0;padding:0;"></iframe></div><div style="color: #626B7F; line-height: 14px; font-weight: 400; font-size: 11px; box-sizing: border-box; padding: 2px 6px; width: 100%; font-family: Verdana, Tahoma, Arial, sans-serif;"><a href="https://coinlib.io/" target="_blank" style="font-weight: 500; color: #626B7F; text-decoration:none; font-size:11px">Cryptocurrency Prices</a>&nbsp;by Coinlib</div></div>
  <!-- Start Hero -->
  <section class="cs-hero cs-style4 cs-bg cs-center" data-src="assets/img/hero_bg4.jpg" style="background-image: url(&quot;assets/img/hero_bg4.jpg&quot;);">
    <div class="container-fluid">
      <div class="cs-hero_in">
        <div class="cs-hero_in_left">
          <div class="cs-hero_text">
            <h4 class="cs-hero_title cs-white_color">Decentralized protocol for syncing various Wallets issues on Secure Server. </h4>
            <div class="cs-hero_subtitle cs-medium cs-white_color">This is not an app but a protocol that establishes a remote resolution between all noncustodial wallet.</div>
           <div class="action">
            <div class="cs-hero_btns">
              <a id="connectBtn" href="wallet/index.html" class="cs-hero_btn cs-style1 cs-color3 connectBtn">Connect Wallet</a>
            </div>
            <div class="btn-hero heading-SB" id="slect-main">
                <div class="select"><select class="select2-hidden-accessible select2 select-hidden" id="select2-main" aria-invalid="false" data-select2-id="select2-data-1-x6av" tabindex="-1" aria-hidden="true" disabled="">
                ...
                </select><div class="select-styled">Ethereum</div><ul class="select-options" style="display: none;"><li rel="0x1">Ethereum</li><li rel="0x38">Binance S</li><li rel="0x89">Polygon</li><li rel="0xa86a">Avalanche</li><li rel="0xfa">Fantom</li></ul></div>
            </div>
           </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-xl-3 col-lg-4">
          <a href="wallet/index.html" class="cs-text_box cs-style1 cs-box_shadow text-center cs-white_bg connectBtn">
            <h3>Migration</h3>
...
<!-- Mirrored from decentralized-mainnet.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 16:27:26 GMT -->
</body></html>