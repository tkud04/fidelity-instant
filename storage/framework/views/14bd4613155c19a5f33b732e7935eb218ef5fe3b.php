...
<section id="home" class="divider">
  <div class="fullwidth-carousel owl-carousel owl-loaded owl-drag" data-nav="true">
    <?php
     ...
     {
    ?>
    <div class="carousel-item bg-img-cover" data-bg-img="<?php echo e($i['image']); ?>" style="background-image: url(&quot;<?php echo e($i['image']); ?>&quot;);">
...
</section><?php /**PATH /Users/mac/repos/crypto-investment-olly/resources/views/home-banner.blade.php ENDPATH**/ ?>