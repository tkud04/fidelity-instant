          ...
          <form id="login-form" name="login-form" class="reservation-form mb-0 bg-silver-light p-30" method="post" action="<?php echo e(url('login')); ?>" novalidate="novalidate">
           ...
           <h3 class="text-center mt-0 mb-30">login to your registered account!</h3>
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group mb-30">
                  <input placeholder="Enter Name" id="login-password" name="pass" required="" class="form-control" aria-required="true" type="password">
                </div>
              </div>
              <div class="col-sm-12">
              ...
              <div class="col-sm-12">
                <div class="form-group mt-15 text-center">
                  <p>Don't have an account? <a href="#register-popup" class="text-theme-colored2 text-underline">Register Here</a> </p>
                </div>
              </div>
            </div>
          </form>
          ...
          <?php echo csrf_field(); ?> 
           <h3 class="text-center mt-0 mb-30">Register here a new account!</h3>
            <div class="row">
              ...
              <div class="col-sm-12">
                <div class="form-group mb-30">
                  <input placeholder="Enter A Valid Email" id="signup-email" name="email" class="form-control" required="" aria-required="true" type="text">
                </div>
              </div>
              <div class="col-sm-12">
                <div class="form-group mb-30">
