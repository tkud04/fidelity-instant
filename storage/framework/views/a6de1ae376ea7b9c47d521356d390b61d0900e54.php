            ...
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40">
              <div class="post bg-white">
                ...
                <div class="entry-content icon-box p-40 mb-sm-50 border-bottom-2px border-theme-colored2 iconbox-theme-colored2 position-relative">
                  <a class="icon icon-top bg-theme-colored2 icon-circled icon-border-effect effect-circled" href="<?php echo e($void); ?>">
...
Our user-friendly, trade-everything platform empowers you to invest in the stocks, cryptocurrencies and metals you want — with any amount of money.
                ...
                <a href="<?php echo e($void); ?>" class="btn btn-flat btn-colored btn-theme-colored2 mt-15 mr-15">Read More</a><a href="<?php echo e($void); ?>" class="btn btn-flat btn-colored btn-default btn-theme-colored mt-15">Get a Quote</a>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box bg-white left media border-3px bg-hover-theme-colored mb-30 p-30 pb-20"> 
                <a href="<?php echo e($void); ?>" class="media-left pull-left"><img src="images/flaticon-png/small/f1.png" alt="" width="64"></a>
                <div class="media-body">
                  ...
                  <a href="<?php echo e($void); ?>" class="text-theme-colored2">Read More →</a>
                </div>
              </div>
            </div>
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box bg-white left media border-3px bg-hover-theme-colored mb-30 p-30 pb-20"> 
                <a href="<?php echo e($void); ?>" class="media-left pull-left"><img src="images/flaticon-png/small/f2.png" alt="" width="64"></a>
                <div class="media-body">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box bg-white left media border-3px bg-hover-theme-colored mb-30 p-30 pb-20"> 
                <a href="<?php echo e($void); ?>" class="media-left pull-left"><img src="images/flaticon-png/small/f3.png" alt="" width="64"></a>
                <div class="media-body">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box bg-white left media border-3px bg-hover-theme-colored mb-30 p-30 pb-20"> 
                <a href="<?php echo e($void); ?>" class="media-left pull-left"><img src="images/flaticon-png/small/f4.png" alt="" width="64"></a>
                <div class="media-body">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box bg-white left media border-3px bg-hover-theme-colored mb-30 p-30 pb-20"> 
                <a href="<?php echo e($void); ?>" class="media-left pull-left"><img src="images/flaticon-png/small/f5.png" alt="" width="64"></a>
                <div class="media-body">
            ...
            <div class="col-xs-12 col-sm-6 col-md-4">
              <div class="icon-box bg-white left media border-3px bg-hover-theme-colored mb-30 p-30 pb-20"> 
                <a href="<?php echo e($void); ?>" class="media-left pull-left"><img src="images/flaticon-png/small/f6.png" alt="" width="64"></a>
                <div class="media-body">
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="mt-50">
                ...
                <form id="reservation_form2" class="reservation-form form-transparent" method="post" action="<?php echo e(url('reservation')); ?>" novalidate="novalidate">
                  <?php echo csrf_field(); ?> 
                  <div class="row">
                    <div class="col-sm-6">
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/mac/repos/fidelity-instant/resources/views/index.blade.php ENDPATH**/ ?>